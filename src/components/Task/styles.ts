...
import { TableHeadCellProps, TableCellProps, TableRowViewProps, EditableCellViewProps } from "./types";
...
const EditableCellView = styled.div<EditableCellViewProps>`
    position: absolute;
    top: 0;
    left: 0;
    bottom: 0;
    ...
    transition: 0.3s;
    box-shadow: ${props => props.editing ? "0 2px 2px 0 rgba(0, 0, 0, .4)" : "none"};
    ...
    input {
        ...
        height: 100%;
        width: 100%;
        padding-left: ${props => props.isCustomComponent ? "0px" : "15px"};
    }
`;
